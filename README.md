...
Gebnerates Firefox and Chrome/Chromium bookmarks based on the ingress resources deployed to this cluster

This chart offers you:
- Kubernetes app with web endpoint
- Helm chart
...
```bash
helm template oci://ghcr.io/hauke-cloud/charts/bookmark-generator
```

#### Deploy the Helm chart

```bash
helm install bookmark-generator oci://ghcr.io/hauke-cloud/charts/bookmark-generator --version 1.0.0
```
